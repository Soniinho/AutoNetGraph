...
class NetworkOperationsController:
    ...
    def setup_network(self):
                ...
                if hasattr(item, 'connections_by_interface'):
                    ...
                    if (len(item.connections_by_interface['enp0s3']) > 0 and
                        ...
                        if root_node is None:  # First root found
                            ...
                            QtWidgets.QMessageBox.warning(None, self.texts["error_1"], self.texts["error_3"])
                            return None
    
        if not root_node:
            QtWidgets.QMessageBox.warning(None, self.texts["error_1"], self.texts["error_4"])
            return None
        ...
        # Configurar interfaces dos outros nós
                ...
                if isinstance(connected_item, MovableRect):
                    ...
                    for interface in connected_item.interfaces:
                        if interface['name'] == connected_node_interface:
                            ...
                            # Configura o gateway se necessário
                    ...
                    # Configurar outra interface com uma nova rede
                    ...
                    # Apenas atualiza o texto se alguma interface foi atualizada
